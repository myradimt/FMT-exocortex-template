...
> **Инструкции:** `/c/Users/Arch_Base/Github/FMT-exocortex-template/CLAUDE.md` | **Настройте под свою экосистему**
...
4. **Отчёты:** ВСЕ репо в /c/Users/Arch_Base/Github/FMT-exocortex-template/
5. **Процессы:** Нельзя реализовывать без PROCESSES.md (CLAUDE.md § 3)

---

## РП текущей недели (W10: 3–7 март)

> Порядок: in_progress → pending → done.

| # | РП | Бюджет | Статус | Дедлайн |
|---|-----|--------|--------|---------|
| 1 | Настройка IWE | 2h | in_progress | 7 март |
